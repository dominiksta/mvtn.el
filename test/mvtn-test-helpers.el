...
(defmacro mvtn-test-with-testfiles (&rest body)
  `(progn
     ...
     (mkdir "1999") (cd "1999")
     (mvtn-test-touch "test1.txt")
     (mvtn-test-touch "test2 test2.txt")
     (mvtn-test-touch "test3 test3.org")
     (cd "..") (mkdir "2020") (cd "2020")
     (mvtn-test-touch "test1.txt")
     (mvtn-test-touch "test2 test2 -- tags tags tags.txt")
     (mvtn-test-touch "test3 test3.org")
     (cd "..") (mkdir "2021") (cd "2021")
     (mvtn-test-touch "test1 -- i have tags.md")
     (mvtn-test-touch "test2 test2.txt")
     (mvtn-test-touch "test3 test3.org")
     (cd "../..")
